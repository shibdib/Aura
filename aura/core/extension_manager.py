...
class ExtensionManager:
    ...
    async def reload_core(self, ctx):
        ...
        bot = ctx.bot
        try:
            bot.unload_extension('aura.core.commands')
            bot.load_extension('aura.core.commands')
            embed = utils.make_embed(msg_type='success',
    ...
    async def reload_dm(self, ctx):
        ...
        bot = ctx.bot
        try:
            bot.unload_extension('aura.data_manager')
            bot.load_extension('aura.data_manager')
            embed = utils.make_embed(msg_type='success',
