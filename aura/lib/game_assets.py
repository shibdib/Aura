...
modules = {  # Attack
    ...
    9: {'id': 9, 'name': 'Nanofiber Internal Structure I', 'class': 3, 'attack': 0, 'defense': 0, 'maneuver': .20,
    ...
    12: {'id': 12, 'name': 'Nanofiber Internal Structure II', 'class': 3, 'attack': 0, 'defense': 0, 'maneuver': .30,
